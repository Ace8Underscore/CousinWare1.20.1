...
public class Button extends Component
{
    ...
    public void renderComponent(DrawContext context) {
        ...
        context.drawBorder(this.parent.getX(), this.parent.getY() + this.offset + 1, this.parent.getX() + this.parent.getWidth(), this.parent.getY() + 16 + this.offset, this.isHovered ? (this.hack.isEnabled() ? new Color(29, 37,48, ClickGuiHack.alpha.getValInt()).getRGB() : new Color(29, 37, 48, ClickGuiHack.alpha.getValInt()).darker().darker().getRGB()) : (this.hack.isEnabled() ? new Color(29, 37,48, ClickGuiHack.alpha.getValInt()).getRGB() : new Color(29, 37, 48, ClickGuiHack.alpha.getValInt()).getRGB()));
        context.drawBorder(this.parent.getX(), this.parent.getY() + this.offset, this.parent.getX() + this.parent.getWidth(), this.parent.getY() + this.offset + 1, new Color(29, 37, 48, ClickGuiHack.alpha.getValInt()).getRGB());
        ...
        if (!Core.customFont.getValBoolean()) {
            if (this.hack.isEnabled())
                context.drawCenteredTextWithShadow(MinecraftClient.getInstance().textRenderer, this.hack.getName(), this.parent.getX() + 2, this.parent.getY() + this.offset + 2 + 2, c.getRGB());
            else
                context.drawCenteredTextWithShadow(MinecraftClient.getInstance().textRenderer,this.hack.getName(), this.parent.getX() + 2, this.parent.getY() + this.offset + 2 + 2, -1);
        } else {
            if (this.hack.isEnabled())
                context.drawCenteredTextWithShadow(MinecraftClient.getInstance().textRenderer,this.hack.getName(), this.parent.getX() + 2, this.parent.getY() + this.offset + 2 + 2, c.getRGB());
            else
