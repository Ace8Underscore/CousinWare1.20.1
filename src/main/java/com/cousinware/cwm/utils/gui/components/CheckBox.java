...
public class CheckBox extends Component
{
    ...
    public void renderComponent(DrawContext context) {
        ...
        context.fill(this.parent.parent.getX() + 1, this.parent.parent.getY() + this.offset, this.parent.parent.getX() + this.parent.parent.getWidth(), this.parent.parent.getY() + this.offset + 16, this.hovered ? (this.op.getValBoolean() ? click2.darker().darker().getRGB() : click2.darker().darker().getRGB()) : (this.op.getValBoolean() ? click2.darker().getRGB() : click2.darker().getRGB()));
