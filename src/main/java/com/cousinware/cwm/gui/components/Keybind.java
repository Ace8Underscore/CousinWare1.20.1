...
public class Keybind extends Component
{
    ...
    public void renderComponent(DrawContext context) {
        context.drawBorder(this.parent.parent.getX(), this.parent.parent.getY() + this.offset + 1, this.parent.parent.getX() + this.parent.parent.getWidth(), this.parent.parent.getY() + this.offset + 15, this.hovered ? new Color(29, 37, 48, ClickGuiHack.alpha.getValInt()).darker().getRGB() : new Color(29, 37, 48, ClickGuiHack.alpha.getValInt()).getRGB());
        ...
        //if (!Core.customFont.getValBoolean()) context.drawCenteredTextWithShadow(MinecraftClient.getInstance().textRenderer,this.binding ? "Press a key..." : ("Key: " + Formatting.GRAY + Keyboard.getKeyName(this.parent.hack.getBind())), this.parent.parent.getX() + 2, this.parent.parent.getY() + this.offset + 4, -1);
       // else context.drawCenteredTextWithShadow(MinecraftClient.getInstance().textRenderer,this.binding ? "Press a key..." : ("Key: " + Formatting.GRAY + Keyboard.getKeyName(this.parent.hack.getBind())), this.parent.parent.getX() + 2, this.parent.parent.getY() + this.offset + 4, -1);
    }
