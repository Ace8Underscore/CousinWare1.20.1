...
public class DoubleSlider extends Component
{
    ...
    public void renderComponent(DrawContext context) {
        context.drawBorder(this.parent.parent.getX(), this.parent.parent.getY() + this.offset + 1, this.parent.parent.getX() + this.parent.parent.getWidth(), this.parent.parent.getY() + this.offset + 16, this.hovered ? new Color(29, 37, 48, ClickGuiHack.alpha.getValInt()).darker().getRGB() : new Color(29, 37, 48, ClickGuiHack.alpha.getValInt()).getRGB());
        final int drag = (int)(this.set.getValDouble() / this.set.getMax() * this.parent.parent.getWidth() + 15);
        context.drawBorder(this.parent.parent.getX(), this.parent.parent.getY() + this.offset + 15, this.parent.parent.getX() + (int)this.renderWidth, this.parent.parent.getY() + this.offset + 16, this.hovered ?new Color(ClickGuiHack.red.getValInt(), ClickGuiHack.green.getValInt(),ClickGuiHack.blue.getValInt(), 255).getRGB() : new Color(ClickGuiHack.red.getValInt(), ClickGuiHack.green.getValInt(),ClickGuiHack.blue.getValInt(), 255).getRGB());
        ...
        if (!Core.customFont.getValBoolean()) context.drawCenteredTextWithShadow(MinecraftClient.getInstance().textRenderer,this.set.getDisplayName(), (int)(this.parent.parent.getX() + 2), this.parent.parent.getY() + this.offset + 4, -1);
        else context.drawCenteredTextWithShadow(MinecraftClient.getInstance().textRenderer,this.set.getDisplayName(), (int)(this.parent.parent.getX() + 2), this.parent.parent.getY() + this.offset + 4, -1);

        if (!Core.customFont.getValBoolean()) context.drawCenteredTextWithShadow(MinecraftClient.getInstance().textRenderer,Formatting.GRAY + String.valueOf(this.set.getValDouble()), (int)(this.parent.parent.getX() + 95), this.parent.parent.getY() + this.offset + 4, -1);
        else context.drawCenteredTextWithShadow(MinecraftClient.getInstance().textRenderer, Formatting.GRAY + String.valueOf(this.set.getValDouble()), (int)(this.parent.parent.getX() + 94), this.parent.parent.getY() + this.offset + 4, -1);
