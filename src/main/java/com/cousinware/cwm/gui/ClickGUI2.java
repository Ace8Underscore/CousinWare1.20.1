...
public class ClickGUI2 extends Screen
{
    ...
    public void render(DrawContext context, int mouseX, int mouseY, float delta) {
        //drawCenteredText();
        context.drawBorder(0, 0, context.getScaledWindowWidth(), context.getScaledWindowHeight(), new Color(ClickGuiHack.red.getValInt(), ClickGuiHack.green.getValInt(),ClickGuiHack.blue.getValInt(), ClickGuiHack.gradiant.getValInt()).getRGB());
